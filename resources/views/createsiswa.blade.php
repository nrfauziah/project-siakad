                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="no" type="no" class="form-control" name="no">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-6">
                                                    ...
                                                    <input id="nama_lengkap" type="nama_lengkap" class="form-control" name="nama_lengkap">
                                                </div>
                                                <div class="form-group col-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <input id="nipd" type="nipd" class="form-control" name="nipd">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-6">
                                                    ...
                                                    <input id="tmp_lahir" type="tmp_lahir" class="form-control" name="tmp_lahir">
                                                </div>
                                                <div class="form-group col-6">
                                                    <label for="tgl_lahir">Tanggal Lahir</label>
                                                    <input id="tgl_lahir" type="tgl_lahir" class="form-control" name="tgl_lahir">
                                                </div>
                                            </div>
